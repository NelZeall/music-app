...
var artists = ["Heavy Metal Official-Audio -live -mix -remix -funny -documentary"];
...
class YoutubeAggressiveMood extends Component {
  ...
  render(){
    ...
    return(
      ...
      <div>
        ...
        <button onClick={this.clicked}>Aggressive Mood</button>
        <ToggleDisplay show={this.state.show}>
          <div id="root" class="videos">
            {
...
export default YoutubeAggressiveMood;
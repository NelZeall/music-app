...
var artists = ["blues|reggae Official-Audio -live -mix -remix -funny -documentary"];
...
class YoutubeEdgeOf extends Component {
...
clicked(){
  ...
  render(){
    ...
    return(
      <div>
        <button onClick={this.clicked}>Take the edge of mood</button>
